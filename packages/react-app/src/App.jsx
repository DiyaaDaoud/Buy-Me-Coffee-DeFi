...
import { ExampleUI, Hints, Subgraph, MainPage, MainOwnerPage } from "./views";
...
function App(props) {
  ...
  let memos = useContractReader(readContracts, "BuyMeCoffee", "getMemos", []);
  let currentOwner = useContractReader(readContracts, "BuyMeCoffee", "owner", []);
  let currentSumTips;
  ...
  */
  ...
  currentSumTips = useContractReader(readContracts, "BuyMeCoffee", "getSumTips", []);
  ...
  currentOwner = useContractReader(readContracts, "BuyMeCoffee", "owner", []);

  if (address) {
    let currentUser = userSigner.address;
    console.log("*********************current owner is :", currentOwner);
    console.log("*********************current user is :", address);
    console.log("******************memos are : ", memos);

    console.log("******************curren amount of money is ", currentSumTips);
    if (address != currentOwner) {
      return (
        <div className="App">
          ...
          <Header />
          {networkDisplay}
          <h1> Wellcome to "Buy Diyaa a Coffee" Official Decentralized App</h1>
          <MainPage tx={tx} writeContracts={writeContracts} price={price}></MainPage>
      ...
      return (
        <div className="App">
          ...
          <Header />
          {networkDisplay}
          <h1> Hello Diyaa. Let's see what we have!</h1>
          <BrowserRouter>
