...
const GOERLI_DEPLOYER_PRIV_KEY = process.env.GOERLI_DEPLOYER_PRIV_KEY;
...
module.exports = {
  ...
  networks: {
    ...
    goerli: {
      url: "https://eth-goerli.g.alchemy.com/v2/0y8CVLPPl3HcHp1DzuViowzAFBmUl2YW", // <---- YOUR INFURA ID! (or it won't work)
